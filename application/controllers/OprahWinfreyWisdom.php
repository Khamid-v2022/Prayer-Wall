...
class OprahWinfreyWisdom extends CI_Controller {
    ...
    {
        $data['title'] = "Oprah Winfrey Wisdom";
        $this->load->view('header_for_tc', $data);
        $this->load->view('winfrey-wisdom', $data);
        $this->load->view('footer');
    }

    public function random_article(){
        $posts = $this->pray_m->get_wp_posts_from_category('Oprah Winfrey Wisdom');
        $count = count($posts);
