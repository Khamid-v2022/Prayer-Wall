...
class SurrenderToGod extends CI_Controller {
    ...
    {   
        $data['title'] = "Surrender To God";
        $this->load->view('header_for_tc', $data);
        $this->load->view('surrender-to-god');
        $this->load->view('footer');
    }

    public function random_article(){
        $posts = $this->pray_m->get_wp_posts_from_category("surrender to god");
        $count = count($posts);
