...
class AngelWelcomingSign extends CI_Controller {
    ...
    {   
        $data['title'] = "Angel Welcoming Sign";
        $this->load->view('header_for_tc', $data);
        $this->load->view('angel-welcoming-sign');
        $this->load->view('footer');
    }

    public function random_article(){
        $posts = $this->pray_m->get_wp_posts_from_category("Angel Welcoming Sign");
        $count = count($posts);
