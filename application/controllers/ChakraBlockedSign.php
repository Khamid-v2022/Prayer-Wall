...
class ChakraBlockedSign extends CI_Controller {
    ...
    {   
        $data['title'] = "Chakra Blocked Sign";
        $this->load->view('header_for_tc', $data);
        $this->load->view('chakra-blocked-sign');
        $this->load->view('footer');
    }

    public function random_article(){
        $posts = $this->pray_m->get_wp_posts_from_category("Chakra Blocked Sign");
        $count = count($posts);
