...
<body>
    <section class="main ourlordmessage">
        ...
        <div class="text-center py-5" style="background: rgba(00, 204, 255);">
            <h1 class="text-white font-46">DAILY DEVOTIONALS</h2>
        ...
        <div class="" id="card_container">  
            ...
            <div class="heading text-center mb-5">
                ...
                <div class="read-today-img">
                    <img loading="lazy" class="img-fluid lord-msg" src="<?=base_url()?>assets/img/banner-01.webp" width="787" height="750" alt="Daily Devotional">
                </div>
                

                <button class="btn btn-primary mt-5 btn-read-message">Read Today's Devotional Message</button>
            </div>
